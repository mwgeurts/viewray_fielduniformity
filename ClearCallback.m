...
% ClearCallback is called by FieldUniformity when a clear data button is
...
% Clear results and refresults
handles.([head,'results']) = [];
handles.([head,'refresults']) = [];
...
% Set table data
set(handles.([head,'table']), 'Data', cell(10, 2));
